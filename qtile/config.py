...
def init_widgets_list():
    widgets_list = [
        widget.Image(
                 filename = "/home/mahdi/.config/qtile/icons/python-white.png",
                 scale = "False",
        ...
        widget.CPU(
                 format = '󰻠 CPU {freq_current}GHz {load_percent}%',
                 foreground = colors[4],
                 decorations=[
                     BorderDecoration(
                         colour = colors[4],
...
def start_once():
    ...
    subprocess.call([home + '/home/mahdi/.config/qtile/autostart.sh'])
